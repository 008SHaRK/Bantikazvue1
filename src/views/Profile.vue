    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <ul class="nav nav-tabs border-0">
          <li class="nav-item">
            <a class="nav-link px-3" :class="{ active: activeTab === 'profile' }" href="#" @click.prevent="activeTab = 'profile'">Hesab məlumatlarım</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-3" :class="{ active: activeTab === 'orders' }" href="#" @click.prevent="activeTab = 'orders'">Bütün sifarişlərim</a>
          </li>
        </ul>
        ...
        <div v-if="activeTab === 'profile'" class="pt-4">
          <form @submit.prevent="handleSubmit">
            ...
            <button type="submit" class="btn btn-danger px-4 py-2 rounded">Yadda Saxla</button>
          </form>
        </div>

        <div v-if="activeTab === 'orders'" class="pt-4">
          <h5 class="fw-semibold mb-4">Sifarişlərim</h5>
          <div v-for="item in orders" :key="item.id" class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
              <img :src="item.image" alt="product" style="width: 64px; height: 64px; object-fit: cover; border-radius: 8px;" />
              <div>
            ...
            <div class="text-end">
              <p class="mb-1 text-muted">{{ item.qty }} x {{ item.unit }}</p>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="successModalLabel">Uğurla yadda saxlanıldı</h5>
...
const orders = ref([
  ...
  },
  {
    id: 2,
    image: '/img/487eda6a280362fa31ec27beb34f0b9f457ed712.png',
    title: 'Morphe 35F Fall Into Fabulob',
    date: '19.12.2022',
    qty: '4h x 32',
    unit: '',
    total: 80
  },
  {
    id: 3,
    image: '/img/487eda6a280362fa31ec27beb34f0b9f457ed712.png',
    title: 'Revolution Eyeshadow Pale..',
    date: '19.12.2022',
    qty: '4h x 32',
    unit: '',
    total: 88
